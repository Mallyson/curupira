...
<?php
    ...
    $twitter_account = apply_filters('theme_twitter_account', '@twitter.com');
    if ($twitter_account) {
?>
...
function theme_ld_meta_tags() {
    ...
    $social_links = apply_filters('theme_social_links', array("https://facebook.com/facebook.com","https://twitter.com/twitter.com","https://www.instagram.com/instagram.com","https://pinterest.com/pinterest.com","https://linkedin.com/in/linkedin.com"));
    ...
    $logo = theme_get_logo(array('default_src' => "/images/logofinal.png", 'default_url' => ''));
    if (!empty($logo['src'])) {
...
function theme_color_meta_tags() {
    $theme_color = apply_filters('theme_color', '#305f3b');
